  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="harga_beli" name="harga_beli" value="<?php if (isset($row['harga_beli']))
          echo $row['harga_beli']; ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="min_stok" name="min_stok" value="<?php if (isset($row['min_stok']))
          echo $row['min_stok']; ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <select id="jenis" name="jenis" class="custom-select">
        ...
        foreach ($rsjenis as $rowjenis) {
          ?>
          <option value="<?= $rowjenis['id'] ?>" <?php
            if ($editmode) {
              if ($rowjenis["id"] == $row['jenis_produk_id'])
                echo "selected";
            }
